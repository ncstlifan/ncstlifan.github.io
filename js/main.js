...
const add_id = "urqommsrttfkjgjp"; // app_id
const app_secret = "Z05MeDJZY2UreWRKa1JzSnFkeTlXUT09"; // app_secret
const key = "da59c45c6c4c4a45a5d748f01ccc9fa4" // key
function getWeather() {
...
$("#weibo").mouseover(function () {
    $("#link-text").html("去 微博 看看");
}).mouseout(function () {
    $("#link-text").html("通过这里联系我");
});

$("#email").mouseover(function () {
    $("#link-text").html("来封 email 叭 ");
}).mouseout(function () {
    $("#link-text").html("通过这里联系我");
});

$("#telegram").mouseover(function () {
    $("#link-text").html("来 电报 联系我叭");
}).mouseout(function () {
    $("#link-text").html("通过这里联系我");
});
...
$('#switchmore').on('click', function () {
    ...
    if (shoemore && $(document).width() >= 990) {
        ...
        $("#change").html("Oops&nbsp;!");
        $("#change1").html("哎呀，这都被你发现咯~（ 再点击一次可关闭 ）");
    } else {
